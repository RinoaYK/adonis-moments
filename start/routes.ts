...
Route.group(() => {
  ...
  Route.get('/moments/comments/:id', 'CommentsController.show')

  Route.patch('/moments/comments/:id', 'CommentsController.update')

  Route.delete('/moments/comments/:id', 'CommentsController.destroy')
}).prefix('/api')
